...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/numberOfTransaction=$1 -G/top/test/seed=$2 -G/top/test/a=$3 -G/top/test/b=$4 top
